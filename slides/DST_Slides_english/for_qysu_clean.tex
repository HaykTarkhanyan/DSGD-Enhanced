...
\usepackage{graphicx} % Required for \end{frame}
...
%gets rid of section navigation in header
...
\begin{frame}{Accuracy vs. Interpretability Tradeoff}
    \begin{overprint}
        \onslide<1-2>\includegraphics[width=0.6\textwidth]{../../fig/interp_over_power.jpg}
        \onslide<3>\includegraphics[width=0.6\textwidth]{../../fig/interp_over_power_accent.jpg}
    \end{overprint}
    
    \onslide<2->{
    \begin{itemize}
        \item Traditional belief: \textbf{more accuracy = less interpretability}
        \item Our goal: Find methods in the \textcolor{red}{\textbf{sweet spot}}
    \end{itemize}
    }
\end{frame}
