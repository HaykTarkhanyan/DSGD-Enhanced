...
class ClusteringSelector:
    ...
    Attributes:
        ...
        clustering_labels (np.array): Labels generated by the K-Means algorithm.
    ...
    def select_best_clustering(self):
        ...
        for n_clusters in self.n_clusters_values:
            ...
            kmeans = KMeans(n_clusters=n_clusters, random_state=42,
                            n_init="auto")
            clustering_labels = kmeans.fit_predict(self.data)
            # Calculate metrics
            kmeans_silhouette = (silhouette_score(self.data, clustering_labels)
        ...
        if kmeans_score > self.best_score_total:
            ...
            self.best_labels = clustering_labels
